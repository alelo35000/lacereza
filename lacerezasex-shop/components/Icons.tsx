...
export const Sparkles: React.FC<{ size?: number, className?: string }> = ({ size = 24, className = '' }) => (
  <svg {...iconProps} width={size} height={size} className={className}><path d="M12 2L14.39 8.61L21 11L14.39 13.39L12 20L9.61 13.39L3 11L9.61 8.61L12 2zM21 15L19.61 17.61L17 19L19.61 20.39L21 23L22.39 20.39L25 19L22.39 17.61L21 15zM8 3L6.39 5.61L4 7L6.39 8.39L8 11L9.61 8.39L12 7L9.61 5.61L8 3z"></path></svg>
);
